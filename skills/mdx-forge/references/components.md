...
function getFrameworkComponents<F extends Framework>(framework: F): readonly string[];
...
function getFrameworkShimPath(framework: Framework, componentName: string): string;
```
